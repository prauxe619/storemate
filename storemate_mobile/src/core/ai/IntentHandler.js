    ...
    async () => {
      ...
      await soldItem.update(
        item => {
          ...
          /*
           * Re-check inside the database transaction.
           */
  ...
  async (
    ...
    try {
      ...
      switch (
         ...
         * Examples:
         *
         * "create product sugar"
         * "add new product sugar"
         * "create sugar price 150 stock 20"
         */
              ...
              await database
                ...
                .create(
                  item => {
                    ...
                    /*
                     * These are the fields already used
                     * throughout the current StoreMate code.
                     */
                    ...
                    /*
                     * Only set barcode if the parser supplied
                     * one and your model supports it.
                     */
                    if (
                      aiResponse.barcode &&
                      typeof item.barcode !==
        ...
        case 'sale.create': {
          ...
          /*
           * No payment method:
           * ask user instead of silently assuming Cash.
           */
