...
export class LedgerEntry extends Model {
  ...
  get ownerId() { return this._getRaw('owner_id'); }
  ...
  get customerPhone() { return this._getRaw('customer_phone'); }

  set ownerId(value) { this._setRaw('owner_id', value); }
  ...
  set customerPhone(value) { this._setRaw('customer_phone', value); }
}
...
export class InventoryItem extends Model {
  ...
  get ownerId() { return this._getRaw('owner_id'); }
  get barcode() { return this._getRaw('barcode'); }
  ...
  set ownerId(value) { this._setRaw('owner_id', value); }
  set barcode(value) { this._setRaw('barcode', value); }
