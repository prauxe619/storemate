...
# Initialize Gemini for Voice Intent Parsing
client = genai.Client(api_key=os.environ.get("GEMINI_API_KEY"))


# ==========================================
# 2. DONUT ML OCR SETUP (PHASE 5)
# ==========================================
...
# Push to GPU if available (makes inference much faster), otherwise use CPU
...
def process_invoice_image(file_path):
    ...
    """
    try:
        # Open image from the saved file path
        ...
        # Decode the output sequence into raw JSON
        ...
        # Map Donut's nested JSON to our Mobile App's format
        formatted_items = []
